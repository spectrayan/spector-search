 ...
 *   <li><b>Promotion cost</b> — shard promotion (VASQ calibration + HNSW bulk-insert) latency</li>
 ...
 * and "does per-shard VASQ calibration add meaningful overhead at promotion time?"</p>
 *
 * <p>Run via:</p>
 * <pre>
